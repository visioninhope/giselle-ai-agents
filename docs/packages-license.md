...
> Python 2.0 license is compatible with Apache-2.0. But License Finder does not
> support the name "Python-2.0". See
> https://github.com/pivotal/LicenseFinder/pull/1053
...
Public License 2.0</a> permitted
...
<a href="https://directory.fsf.org/wiki/License:BSD-4-Clause">BSD</a> manually
approved

> The BSD license is ambiguous. The license is now BSD 3-Clause from
> url-template v3.1.0. See https://github.com/bramstein/url-template/pull/47
