...
export const Output = z.object({
	...
	accesor: z
		.string()
		.describe(
			"Field used for data access. Used to link properties of information generated by action nodes such as TextGeneration with Outputs. For example, in TextGeneration node, Output accessors would be generated-text, reasoning, source.",
		),
});
