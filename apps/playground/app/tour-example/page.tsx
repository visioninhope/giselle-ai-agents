...
export default function TourExamplePage() {
	...
	const tourSteps = [
		...
		},
		{
			...
			content:
				"Get help when you need it. Explore our comprehensive <a href=\"https://docs.giselles.ai/introduction\" style={{textDecoration: 'underline'}}>Docs</a> for detailed guidance and best practices whenever you encounter challenges.",
			placement: "bottom" as const,
		},
	];
		...
		>
			...
			<div className="max-w-6xl mx-auto relative z-10">
				<div className="flex justify-between items-center mb-8">
					<h1 className="text-2xl font-bold" id="step1">
						Giselle Platform
					</h1>
					<button
						type="button"
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					<div className="bg-black-800 p-6 rounded-lg">
						<h2 className="text-xl font-semibold mb-4" id="step2">
							Create Workflow
						</h2>
					...
					<div className="bg-black-800 p-6 rounded-lg">
						<h2 className="text-xl font-semibold mb-4" id="step3">
							Components
						</h2>
						<p className="text-gray-400">
						...
						<div className="mt-4 flex flex-wrap gap-2">
							<span className="px-2 py-1 bg-black-700 rounded text-xs">
								Text
							</span>
							<span className="px-2 py-1 bg-black-700 rounded text-xs">
								Image
					...
					<div className="bg-black-800 p-6 rounded-lg">
						<h2 className="text-xl font-semibold mb-4" id="step4">
							Deploy
						</h2>
						<p className="text-gray-400">
				...
				<div className="mt-8 bg-black-800 p-6 rounded-lg">
					<h2 className="text-xl font-semibold mb-4" id="step5">
						Settings & Integrations
					</h2>
					<p className="text-gray-400">
						Configure your agents and integrate with external tools and
						services.
					</p>
				...
				<div className="mt-8 bg-black-800 p-6 rounded-lg">
					<h2 className="text-xl font-semibold mb-4" id="step6">
						Help & Resources
					</h2>
					<p className="text-gray-400">
						Get assistance and access additional resources to maximize your
						experience.
					</p>
					<div className="mt-4 grid grid-cols-2 gap-3">
						<a
							href="https://docs.giselles.ai"
							className="px-3 py-1.5 bg-primary-700/60 rounded text-sm text-center"
						>
							Documentation
						</a>
						<a
							href="https://forum.giselles.ai"
							className="px-3 py-1.5 bg-primary-700/60 rounded text-sm text-center"
						>
							Community Forum
						</a>
						<a
							href="https://tutorials.giselles.ai"
							className="px-3 py-1.5 bg-primary-700/60 rounded text-sm text-center"
						>
							Tutorials
						</a>
						<a
							href="https://support.giselles.ai"
							className="px-3 py-1.5 bg-primary-700/60 rounded text-sm text-center"
						>
							Contact Support
						</a>
