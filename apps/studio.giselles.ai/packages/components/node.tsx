...
export function Node({
	...
	return (
		<div
			...
			className={clsx(
				"group relative rounded-[16px] bg-linear-to-tl min-w-[180px] backdrop-blur-[1px] transition-shadow",
								...
								<div className="absolute -right-[10px] translate-x-[6px]">
									...
									<Handle
										...
										className={clsx(
											...
											"group-data-[type=action]:border-[hsla(195,74%,21%,1)]! data-[state=connected]:group-data-[type=action]:bg-[hsla(187,71%,48%,1)]! hover:group-data-[type=action]:bg-[hsla(187,71%,48%,1)]!",
											"group-data-[type=variable]:border-[hsla(236,7%,39%,1)]! data-[state=connected]:group-data-[type=variable]:bg-white!",
										)}
									/>
								</div>
								<div className="text-[14px] text-black--30 px-[12px]">
