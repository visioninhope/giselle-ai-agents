CREATE TABLE IF NOT EXISTS "invitations" (
	...
	"email" text NOT NULL,
	"role" text NOT NULL,
	"invite_user_db_id" integer NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "invitations" ADD CONSTRAINT "invitations_invite_user_db_id_users_db_id_fk" FOREIGN KEY ("invite_user_db_id") REFERENCES "public"."users"("db_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
