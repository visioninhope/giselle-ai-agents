					...
					{activities.length > 0 ? (
						activities.map((activity) => (
							<div
								...
								className="grid grid-cols-4 gap-1 py-2 items-cente border-b-[0.5px] border-black-400 text-white-400 font-hubotSans font-medium text-[12px] leading-[14.4px] tracking-normal"
							>
