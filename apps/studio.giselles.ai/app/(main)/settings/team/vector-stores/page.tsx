      ...
      <Card className="rounded-[8px] bg-transparent p-6 border-0">
        <div className="flex flex-col items-center justify-center py-8">
          ...
          <a
            ...
            className="group relative overflow-hidden rounded-lg px-4 py-2 text-white transition-all duration-300 hover:scale-[1.01] active:scale-95 inline-flex items-center gap-1.5 font-sans text-[14px] font-medium"
            style={{
              boxShadow:
          ...
          >
            ...
            {/* Content */}
            <span className="relative z-10">Open Authentication Settings</span>
      ...
      <Card className="rounded-[8px] bg-transparent p-6 border-0">
        <div className="flex flex-col items-center justify-center py-8">
          ...
          >
            ...
            {/* Content */}
            <span className="relative z-10">Open Integrations Settings</span>
