			...
			style={
				{
					...
					background: "linear-gradient(135deg, rgba(100,130,200,0.20) 0%, rgba(60,80,120,0.35) 40%, rgba(20,30,60,0.85) 100%)",
				...
				>
					<div className="flex h-full flex-col">
						<div className="aspect-video w-full rounded-lg bg-white/5 flex items-center justify-center">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 486 640" className="h-12 w-12 text-white/30" fill="currentColor">
