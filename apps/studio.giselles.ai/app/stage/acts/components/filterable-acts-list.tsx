...
import { CheckIcon, ChevronDownIcon, Search, Trash2 } from "lucide-react";
...
function matchesSearchFilters(
	...
	// Note: archived status doesn't exist yet, so this is commented out
						...
						<Table className="table-fixed w-full">
							<TableHeader>
								<TableRow>
									...
									<TableHead className="w-[280px] text-white-100">
										App
									</TableHead>
