...
export default async function StagePage() {
  ...
  return (
    <div className="px-[24px] min-h-screen bg-[var(--color-stage-background)]">
      <div className="grid grid-cols-[65%_35%] min-h-screen">
        <div className="space-y-6 py-6 pr-6 border-r border-black-70/50">
