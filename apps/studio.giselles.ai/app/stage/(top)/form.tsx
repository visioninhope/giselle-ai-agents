...
export function Form({
	...
	return (
		<div className="space-y-0 relative h-full flex flex-col">
										...
										>
											...
											<div className="flex flex-col gap-y-1 min-w-0 flex-1">
												...
												{(() => {
													...
													return label && label !== "Manual Trigger" ? (
			...
			{/* Slide-up Modal */}
			{!isCarouselView && selectedFlowTriggerId !== undefined && (
				<div className="absolute bottom-0 left-0 right-0 z-50 animate-in slide-in-from-bottom-full duration-300">
							...
							<div className="flex items-center gap-3">
								...
								<div className="flex flex-col">
									<h3 className="font-sans text-[16px] font-medium tracking-tight text-white-100">
										{filteredFlowTriggers.find(
											(trigger) => trigger.id === selectedFlowTriggerId,
										)?.workspaceName || "Untitled"}
									</h3>
									{(() => {
										const selectedTrigger = filteredFlowTriggers.find(
											(trigger) => trigger.id === selectedFlowTriggerId,
										);
										const label = selectedTrigger?.label;
										return label && label !== "Manual Trigger" ? (
