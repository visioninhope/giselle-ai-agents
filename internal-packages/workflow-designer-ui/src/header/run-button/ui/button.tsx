...
export function Button({
	...
	return (
		<button
			type="button"
			className={clsx(
				"bg-black-750 px-[14px] rounded-[4px] py-[4px] text-[14px] flex items-center gap-[4px] outline-none text-black-200 font-medium font-accent cursor-pointer hover:bg-black-800 data-[state=open]:bg-black-800",
