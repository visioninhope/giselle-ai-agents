					...
					<DropdownMenu.Portal>
						...
						>
							...
							<div className="relative flex flex-col gap-[8px]">
								<div className="flex px-[16px] text-white-900">Insert Sources</div>
									...
									<div className="flex flex-col px-[8px]">
										{connectedSources.map((source) => (
											<DropdownMenu.RadioItem
												...
												className="p-[8px] rounded-[8px] text-white-900 hover:bg-blue/50 transition-colors cursor-pointer text-[12px] outline-none select-none"
