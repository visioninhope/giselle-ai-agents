...
export const tableStyles = {
  ...
  badge: {
    success: "w-4 h-4 rounded-full bg-[#39FF7F] text-black text-xs flex items-center justify-center font-bold",
    error: "w-4 h-4 rounded-full bg-[#FF3D71] text-black text-xs flex items-center justify-center font-bold",
    warning: "w-4 h-4 rounded-full bg-[#FFE551] text-black text-xs flex items-center justify-center font-bold",
  },
} as const;
