...
import { Dialog, RadioGroup, DropdownMenu } from "radix-ui";
                ...
                >
                  ...
                  >
                    <div className="flex items-center w-full">
                      {accessScope === "team" && <CheckIcon size={16} className="text-white-900 mr-2" />}
                      <span className={`${accessScope === "team" ? "" : "pl-6"} text-white-900 font-medium text-[14px]`}>
                  ...
                  >
                    <div className="flex items-center w-full">
                      {accessScope === "anyone" && <CheckIcon size={16} className="text-white-900 mr-2" />}
                      <span className={`${accessScope === "anyone" ? "" : "pl-6"} text-white-900 font-medium text-[14px]`}>
                        Anyone
                      </span>
                    </div>
                  </DropdownMenu.Item>
                ...
                >
                  <div className="flex items-start mb-2">
                    <div className={clsx(
                      ...
                      {permission === "view" && <div className="w-2 h-2 rounded-full bg-primary-100" />}
                    </div>
                    <div>
                      <div className="text-white-900 text-[14px] font-medium">Viewer access</div>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-start mb-2">
                    <div className={clsx(
                      ...
                      {permission === "edit" && <div className="w-2 h-2 rounded-full bg-primary-100" />}
                    </div>
                    <div>
                      <div className="text-white-900 text-[14px] font-medium">Editor access</div>
                    </div>
                  </div>
                  <p className="text-[#5C6484] text-[13px] ml-6">
