...
export function ImageGenerationLoading({
	...
	return (
		<div
			className="bg-white-900/10 rounded-[8px] flex items-center justify-center text-white-400 relative overflow-hidden"
			style={{
				aspectRatio,
				maxWidth: "400px",
				maxHeight: "300px",
      ...
      `}</style>
			<div className="flex items-center gap-[4px] absolute top-[12px] left-[12px] text-white-400">
				<p
